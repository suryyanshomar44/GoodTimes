...
function CouponBrand() {
  ...
  //   try {
  //     axios
  //       .post(`api/guest/couponsfiltered?store=Amazon`)
  //       .then((response) => {
    ...
    <Header setInput={setInput} text="Search for store and brands" input={input}/>
      <div className="coupon-nav-2">
        ...
        <ul className="coupon-nav-2-list mt-2">
           ...
           <li className="coupon-nav-2-listitem"  onClick={() => navigate("/coupons/category")}>Categories</li>
        ...
        <Row>
                ...
                {Newcountry?.flat().map((data)=>{
                  ...
                  <Col>
                    <div  style={{cursor:'pointer'}}onClick={() =>
                     ...
                     <img className="coupon-flag-img" style={{width:'50px'}}src={`https://countryflagsapi.com/svg/${data}`} alt="flag" />
                      <span className="brand-flag-coupon" style={{fontSize:'13px',whiteSpace: 'nowrap'}}> {data}</span>
                    </div>
                  </Col>
          ...
          <Col lg={8}>
            <h2 className="brand-right-1-cards">
              <b>
                {Brand} discount offers and discount codes &nbsp; {AllMonth[month]} {year}
              </b>
              <br />
